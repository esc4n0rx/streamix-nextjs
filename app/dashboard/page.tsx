...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      {/* Efeito de blur para o card principal */}
      <div className="absolute inset-0 bg-black bg-opacity-50 backdrop-blur-lg z-0"></div>

      {/* Card principal envolvendo tudo */}
      <div className="relative z-10 p-4 sm:p-8"> {/* Adicionado padding responsivo */}

        {/* Navbar - estilo dock flutuante */}
        <nav className="fixed bottom-0 left-0 right-0 z-20 flex justify-center bg-black bg-opacity-80 py-4">
          <ul className="flex space-x-2 sm:space-x-6"> {/* Espaço menor para mobile */}
        ...
        <div className="my-8">
          ...
          <div className="relative w-full h-56 sm:h-96 overflow-hidden"> {/* Ajuste de altura para mobile */}
        ...
        <div className="my-8">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4"> {/* Colunas ajustadas para mobile */}
            {conteudos
        ...
        {/* Pop-up com detalhes do conteúdo */}
        {selectedContent && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-30">
            <div className="bg-gray-900 p-4 sm:p-8 rounded-lg max-w-xs sm:max-w-md mx-auto text-center"> {/* Tamanho ajustado */}
